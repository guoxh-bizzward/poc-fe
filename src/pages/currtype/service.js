...
//定义接口地址
const URL = {
    "GET_DETAIL":  `${GROBAL_HTTP_CTX}/currtype/list`,
    "SAVE_ORDER":  `${GROBAL_HTTP_CTX}/currtype/save`,
    "GET_LIST":  `${GROBAL_HTTP_CTX}/currtype/list`,
    "DEL_ORDER":  `${GROBAL_HTTP_CTX}/currtype/deleteBatch`,
...
export const saveCurrtype = (params) => {
    return request(URL.SAVE_ORDER, {
        method: "post",
        data: params
    });
}
export const delCurrtype = (params) => {
